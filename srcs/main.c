...
/*   Updated: 2018/07/25 02:54:56 by sclolus          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const t_hash_identity	g_supported_hashs[SUPPORTED_TYPES] = {
	...
	{"sha224", parse_sha256, sha224_hash, CC_SHA224, sha256_cmd_exec, 7 * 4, SHA224, {0}}, //same exec and cmd_parse functions, it's okay now, but hey should change that
	{"sha512", parse_sha256, (t_hash_function)sha512_hash, CC_SHA512, sha256_cmd_exec, 8 * 8, SHA512, {0}}, //same exec and cmd_parse functions, it's okay now, but hey should change that
